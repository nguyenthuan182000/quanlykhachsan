            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <h5 class="card-title m-b-0"><a href="addtintuc.php ">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                foreach ($tin_tucs as $key=> $value)
                                {
                                    ...
                                    <tr>
                                        <td><?php echo $i++;?></td>
                                        <td><img src="../public/layout/image_tin_tuc/<?php echo $value->hinh?>" width="80px" height="50px"></td>
                                        <td><?php echo $value->ten_tin_tuc;?></td>
                                        ...
                                        <td ><?php if($value->trang_thai ==0){?>
                                            ...
                                            <?php } ?></td>
                                        <td><button type="button" id="btnSua" onclick="window.location.href='edittintuc.php?id=<?php echo $value->id;?>'" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>Edit</button></td>
                                    </tr>
                                    <?php
                                }
                                ?>
