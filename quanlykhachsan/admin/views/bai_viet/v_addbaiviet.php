                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="ten_bai_viet" name="ten_bai_viet" placeholder="Tên bài viết" required="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nội dung</label>
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="noi_dung" rows="6" name="noi_dung" rows="3" placeholder="Nội dung" required=""></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="ngay_them" name="ngay_them" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
