                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="ten_loai_phong" name="ten_loai_phong" placeholder="Tên loại phòng" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="thong_tin" name="thong_tin" placeholder="Thông tin" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
