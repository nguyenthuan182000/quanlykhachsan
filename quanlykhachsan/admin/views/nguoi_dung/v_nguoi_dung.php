            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <!-- /.card-header -->
                        <div class="card-body">
                            <h5 class="card-title m-b-0"><a href="addnguoidung.php">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                //
                                $i=1;
                                foreach ($nguoi_dungs as $key=> $value)
                                {
                                    ?>
                                    <tr>
                                        <td><?php echo $i++;?></td>
                                        ...
                                        <td ><?php if($value->trang_thai ==0){?>
                                            ...
                                            <?php } ?></td>
                                        <td><button type="button" id="btnSua" onclick="window.location.href='editnguoidung.php?id=<?php echo $value->id; ?>'" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i>Edit</button></td>
                                    </tr>
                                    <?php
                                }
                                ?>
