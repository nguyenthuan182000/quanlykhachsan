                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="post">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="ten_dich_vu" name="ten_dich_vu" placeholder="Tên dịch vụ" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Thông tin</label>
                                        <div class="col-sm-9">
                                            <textarea type="text" class="form-control" id="thong_tin" name="thong_tin" rows="3" placeholder="Thông tin chi tiết" required></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
